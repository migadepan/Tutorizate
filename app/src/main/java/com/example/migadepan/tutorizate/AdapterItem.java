...
public class AdapterItem extends BaseAdapter {
    ...
    public AdapterItem(Activity activity, ArrayList<Tutoria> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            v = inf.inflate(R.layout.lista_tutorias_reservadas, null);
        }

        Tutoria tutoria = items.get(position);
        TextView nombreAlumno = (TextView) v.findViewById(R.id.nombreAlumno);
        nombreAlumno.setText(tutoria.getNombreAlumno());
